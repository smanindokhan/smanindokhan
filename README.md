...
- 📊 Build **end-to-end analytics systems** (tracking → pipelines → dashboards)  
- 💰 Work on **pricing, margins, and profitability** across large product catalogs  
- 🚴 Optimize **marketplace dynamics** (supply, incentives, allocation, performance)  
- 📈 Analyze **user behavior** (funnels, cohorts, retention, attribution)  
- ⚙️ Develop **data pipelines & automation workflows** across multiple sources  
- 🤖 Automate repetitive and manual processes using scripts and workflow tools  
- 🔍 Improve **data reliability, tracking, and reporting accuracy**  

---

## 🌍 Domain Experience

- 📡 **Telco / eSIM / Digital Products**  
  Pricing, product catalogs, partner integrations, affiliate tracking, analytics foundations  

- 🍔 **Food Delivery Platforms**  
  Supply-demand optimization, rider incentives, operational analytics, marketplace performance  

- 🚗 **Ride-Sharing Platforms**  
  Growth strategy, dynamic pricing/commissions, churn reduction, fraud detection  
...
![](https://github-readme-stats.vercel.app/api?username=smanindokhan&theme=tokyonight&hide_border=false&include_all_commits=false&count_private=true)  
![](https://github-readme-streak-stats.herokuapp.com/?user=smanindokhan&theme=tokyonight&hide_border=false)  

---

[![](https://visitcount.itsvg.in/api?id=smanindokhan&icon=8&color=0)](https://visitcount.itsvg.in)
